          ...
          >
            ...
            <Link href={item.link} rel="noopener noreferrer" target="_blank">
              <Image
                ...
                src={item.image}
                alt={item.name}
                className="object-cover !m-0 !p-0 object-top rounded-full h-32 w-32 border-2 cursor-pointer group-hover:scale-105 group-hover:z-30 border-white relative transition duration-500"
              />
            </Link>
